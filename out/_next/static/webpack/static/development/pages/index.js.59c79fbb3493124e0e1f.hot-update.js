...
/* harmony import */ var antd_lib_icon_style_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! antd/lib/icon/style/css */ "./node_modules/antd/lib/icon/style/css.js");
...
/* harmony import */ var _layout_head__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../layout/head */ "./layout/head.js");
/* harmony import */ var _less_App_less__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../less/App.less */ "./less/App.less");
/* harmony import */ var _less_App_less__WEBPACK_IMPORTED_MODULE_18___default = /*#__PURE__*/__webpack_require__.n(_less_App_less__WEBPACK_IMPORTED_MODULE_18__);
/* harmony import */ var _foot__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./foot */ "./components/foot/index.js");
/* harmony import */ var _head__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./head */ "./components/head/index.js");
/* harmony import */ var _sidebar__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./sidebar */ "./components/sidebar/index.js");
...
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_14__["default"])(App, _Component);
  ...
  function App(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_15__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_13__["default"])(_this), "handleClick", function () {
      _this.setState({
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_10__["default"])(App, [{
    ...
    value: function render() {
      var _this$props = this.props,
          articals = _this$props.articals,
          visitors = _this$props.visitors,
          children = _this$props.children;
      var button = null;

      if (this.state.sidebar) {
        button = __jsx(antd_lib_icon__WEBPACK_IMPORTED_MODULE_8___default.a, {
          type: "double-right",
          className: _less_App_less__WEBPACK_IMPORTED_MODULE_18___default.a.icon,
          style: {
            color: "#fff"
          }
        });
      ...
      return __jsx(react__WEBPACK_IMPORTED_MODULE_16___default.a.Fragment, null, __jsx(_layout_head__WEBPACK_IMPORTED_MODULE_17__["default"], null), __jsx("div", {
        className: _less_App_less__WEBPACK_IMPORTED_MODULE_18___default.a.App,
        style: {
          right: this.state.sidebar ? '160px' : '0px',
          width: '100%'
        }
      }, __jsx(_head__WEBPACK_IMPORTED_MODULE_20__["default"], null), __jsx("div", {
        className: _less_App_less__WEBPACK_IMPORTED_MODULE_18___default.a.main
        ...
        sm: 24,
        xs: 24
      }, children))), __jsx(_foot__WEBPACK_IMPORTED_MODULE_19__["default"], null)), __jsx("div", {
        className: _less_App_less__WEBPACK_IMPORTED_MODULE_18___default.a.side,
        style: {
        ...
        className: _less_App_less__WEBPACK_IMPORTED_MODULE_18___default.a.control,
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _Promise$all = _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a.all(getArticals({}), getVisitorMount()), _Promise$all2 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_2__["default"])(_Promise$all, 2), articals = _Promise$all2[0], visitors = _Promise$all2[1];
...
//# sourceMappingURL=index.js.59c79fbb3493124e0e1f.hot-update.js.map